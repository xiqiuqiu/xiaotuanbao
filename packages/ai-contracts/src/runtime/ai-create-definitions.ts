...
export const AI_CREATE_CAPABILITY_REFS_BY_TOOL = {
  ...
  searchUsers: {
    key: 'departure.user.search',
    version: SEARCH_USERS_TOOL.version,
  },
  searchSuppliers: {
  ...
  searchPartners: {
    key: 'departure.partner.search',
    version: SEARCH_PARTNERS_TOOL.version,
  },
  submitReviewPackage: {
...
export const AI_CREATE_CAPABILITY_DEFINITIONS = [
  ...
  {
    ...AI_CREATE_CAPABILITY_REFS_BY_TOOL.searchUsers,
    toolName: SEARCH_USERS_TOOL.name,
    kind: 'read',
    risk: 'low',
    requiredPermissionKeys: ['departure:write'],
    requiredObjectScopes: [],
    inputSchema: searchUsersModelInputSchema,
  ...
  {
    ...AI_CREATE_CAPABILITY_REFS_BY_TOOL.searchSuppliers,
  ...
  {
    ...AI_CREATE_CAPABILITY_REFS_BY_TOOL.searchPartners,
