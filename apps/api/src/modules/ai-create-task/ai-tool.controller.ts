...
export class AiToolController {
  ...
  @Post('v1/propose-source-order-review-package')
  @HttpCode(200)
  proposeSourceOrderReviewPackage(
    @Req() request: { user: AiToolRequestUser },
    @Body() body: unknown,
  ) {
    return this.aiToolHttpAdapter.proposeSourceOrderReviewPackage(request.user, body)
  }
  ...
  @Post('v1/propose-departure-resource-review-package')
  @HttpCode(200)
  proposeDepartureResourceReviewPackage(
    @Req() request: { user: AiToolRequestUser },
    @Body() body: unknown,
  ) {
    return this.aiToolHttpAdapter.proposeDepartureResourceReviewPackage(request.user, body)
  }
