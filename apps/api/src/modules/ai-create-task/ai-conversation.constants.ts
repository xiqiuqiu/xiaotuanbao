...
export const RETRACT_QUEUED_BATCH_OPERATION = 'ai-conversation.retract-queued-batch'
...
export const CONVERSATION_GENERAL_SYSTEM_PROMPT_VERSION = 'conversation-general/v6'
...
export const DEPARTURE_COLLABORATION_SYSTEM_PROMPT_VERSION = 'departure-collaboration/v3'
export const DEPARTURE_COLLABORATION_TOOL_SCHEMA_VERSION = 'departure-collaboration-tools/v3'
