...
const PUBLIC_MUTATING_ALLOWLIST = new Set<string>([
  ...
  'POST /api/agent/conversations/:conversationId/unarchive',
  'PUT /api/agent/conversations/:conversationId/draft',
  'POST /api/agent/conversations/:conversationId/interactions/:interactionId/cancel',
  'POST /api/agent/conversations/:conversationId/batches/:batchId/retry-failed-materials',
  ...
  'POST /api/ai-tools/v1/propose-departure-resource-review-package',
  ...
  'POST /api/ai-tools/v1/search-partners',
  'POST /api/ai-tools/v1/get-material-parse-result',
  'POST /api/ai-tools/v1/read-conversation-history',
  'POST /api/ai-tools/v1/read-conversation-source',
])
...
const CAPABILITY_ENDPOINTS: Record<CapabilityId, Array<{ method: string; path: string }>> = {
  departureWrite: [
    ...
    { method: 'POST', path: '/api/agent/tasks/departure-creation/sessions' },
    { method: 'PATCH', path: '/api/agent/review-packages/:packageId' },
    { method: 'POST', path: '/api/agent/review-packages/:packageId/confirm' },
