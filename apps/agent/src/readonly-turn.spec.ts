...
describe('READONLY_ASSIST_INSTRUCTIONS', () => {
  it('requires getTaskContext, allows submitReviewPackage, and forbids draft writes', () => {
    ...
    expect(READONLY_ASSIST_INSTRUCTIONS).toContain('不要填写 messageId')
    expect(READONLY_ASSIST_INSTRUCTIONS).toContain('同一日历日')
    expect(READONLY_ASSIST_INSTRUCTIONS).toContain('startDate plus')
